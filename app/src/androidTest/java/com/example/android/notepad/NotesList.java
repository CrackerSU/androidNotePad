...
public class NotesList extends ListActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Cursor cursor = managedQuery(
                ...
                PROJECTION,                       // Return the note ID, title and note for each note.
                null,                             // No where clause, return all records.
                null,                             // No where clause, therefore no where column values.
                NotePad.Notes.DEFAULT_SORT_ORDER  // Use the default sort order.
        );
        Log.d("NotesList", "Query result count: " + cursor.getCount());
        // Sets the ListView's adapter to be the cursor adapter that was just created.
        NotesListAdapter adapter = new NotesListAdapter(this, cursor);
    ...
    private void initCategorySpinner() {
        ...
        // We handle this by checking for ID -1 in our filter logic
    ...
    private void refreshNotesList() {
        ...
        ((NotesListAdapter) getListAdapter()).changeCursor(cursor);
    }
...
// 在 NotesList.java 的 onOptionsItemSelected 方法中添加
    ...
    // 在 NotesList.java 的 onCreateOptionsMenu 方法中添加
